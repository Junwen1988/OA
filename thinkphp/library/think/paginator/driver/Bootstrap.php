...
class Bootstrap extends Paginator
{
    ...
    public function render()
    {
        if ($this->hasPages()) {
            if ($this->simple) {
                ...
                return sprintf(
                    '<ul class="pagination ui">%s %s %s</ul>',
                    $this->getPreviousButton(),
                    $this->getLinks(),
                    $this->getNextButton()
                );
    ...
    {
        return '<li><a class="ui button" href="' . htmlentities($url) . '">' . $page . '</a></li>';
    }
    ...
    {
        return '<li class="disabled ui button"><span>' . $text . '</span></li>';
    }
    ...
    {
        return '<li class="active ui button blue"><span>' . $text . '</span></li>';
    }
